...
function request_to_check(userId, total_price, email, name, phone, address) {
	IMP.request_pay({
	    pg : 'inicis',
	    pay_method : 'card',
...
<body>
	...
	<div class="container">
		...
		<div class="data col-md-12 info">
			...
			<c:forEach items="${product}" var="product">
				...
				<div>
					...
					<div class="col-md-4" style="color:red; height:150px; line-height: 100px;"><fmt:formatNumber value= "${product.total}"/></div>
				</div>
			</c:forEach>
		</div>
		...
		<div class="col-md-12 data order-details">
			...
			<div class="col-sm-4">
				<a href="#" onclick="request_to_check('${user.id}', '${payment_total}', '${user.email}', '${user.name}','${user.phone}' ,'${user.address}')" class="primary-btn order-submit">결제하기</a>
			</div>
